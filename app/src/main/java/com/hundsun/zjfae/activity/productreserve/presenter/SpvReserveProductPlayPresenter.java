...
public class SpvReserveProductPlayPresenter extends BasePresenter<ReserveProductPlayView> {
    ...
    public SpvReserveProductPlayPresenter(ReserveProductPlayView baseView) {
        super(baseView);
    }
