package com.hundsun.zjfae.activity.logingesture.widget;
...
public class LockPatternView extends View {
    ...
    private Paint defaultPaint, selectPaint, errorPaint, contentPaint;
    ...
    private String[] content = new String[]{"安", "全", "专", "业", "便", "捷"};
    private Paint.FontMetrics fontMetrics;
    private int position = 0;//指示当前选中的是第几个的标识 用于取数组里面的文字数据
...
//							this.cellInnerRadius, this.selectPaint);
                    ...
                    selectPaint.setStyle(Style.FILL);
                    canvas.drawCircle(mCells[i][j].getX(), mCells[i][j].getY(),
                            this.cellRadius - 10, this.selectPaint);
...
//                            this.cellInnerRadius, this.errorPaint);
                    errorPaint.setStyle(Style.FILL);
                    canvas.drawCircle(mCells[i][j].getX(), mCells[i][j].getY(),
                            this.cellRadius - 10, this.errorPaint);
                }
            }
        }
        ...
        if (sCells.size() > 0) {
            ...
            position =0;
            canvas.drawText(content[position], tempCell.getX(), tempCell.getY() - fontMetrics.top / 2 - fontMetrics.bottom / 2, contentPaint);
...
//                    drawNewTriangle(tempCell, cell, canvas, selectPaint);
                    ...
                    if (position >= content.length) {
                        canvas.drawText("", cell.getX(), cell.getY() - fontMetrics.top / 2 - fontMetrics.bottom / 2, contentPaint);
                    } else {
                        canvas.drawText(content[position], cell.getX(), cell.getY() - fontMetrics.top / 2 - fontMetrics.bottom / 2, contentPaint);
                    }
...
//                    drawNewTriangle(tempCell, cell, canvas, errorPaint);
    ...
    private void initPaints() {
        ...
        fontMetrics = contentPaint.getFontMetrics();
    }
