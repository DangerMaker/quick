...
class SpvProductDetailActivity : CommActivity<SpvProductDetailPresenter>(), SpvProductDetailView,
     ...
     *支付辅助类
     * */
    private val playInfo: ProductPlayBean = ProductPlayBean()
    ...
    override fun initData() {
        ...
        playInfo.buyRemainAmount = intent.getStringExtra("delegateNum")

        sellingStatus = intent.getStringExtra("sellingStatus")


        val leftDays = intent.getStringExtra("leftDays")
    ...
    fun setDisclaimer() {
        ...
        if (StringUtils.isNotBlank(baseCacheBean.button_title)) {
            ...
            after.setSpan(object : ClickableSpan() {
                override fun onClick(widget: View) {
                    baseStartActivity(this@SpvProductDetailActivity, DisclaimerActivity::class.java)
                }
    ...
    override fun getTransferOrderSecBean(orderSecBean: TransferOrderSec.Ret_PBIFE_trade_transferOrderSec?) {
        ...
        intent.setClass(this, SpvProductPlayActivity::class.java)
    ...
    override fun onProductData(
        ...
        if (playInfo.ifAllBuy == "1") {
            productAmountDialog.setMessage(playInfo.buyRemainAmount)
