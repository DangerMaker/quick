...
public class UserInfoInputDialog extends Dialog {
    ...
    public UserInfoInputDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public Builder setPositiveButton(int confirm_btnText,
                                         OnClickListener listener, String text) {
        ...
        public UserInfoInputDialog create() {
            LayoutInflater inflater = LayoutInflater.from(context);
            // instantiate the dialog with the custom Theme
            final UserInfoInputDialog dialog = new UserInfoInputDialog(context, R.style.mystyle);
            View layout = inflater.inflate(R.layout.dialog_userinfoinput_layout, null);
            ...
            if (confirm_btnText != null) {
                ...
                layout.findViewById(R.id.confirm_btn).setVisibility(
                        View.GONE);
                layout.findViewById(R.id.mind_line).setVisibility(
                        View.GONE);
            }
            ...
            et = layout.findViewById(R.id.edit);
