...
public class RegisterImageCodeDialog extends Dialog {
    ...
    public RegisterImageCodeDialog(Context context) {
        super(context);
    }

    public RegisterImageCodeDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public RegisterImageCodeDialog create() {
            final ImageView imageCode;
            final EditText ed_imageCode;
            LayoutInflater inflater = LayoutInflater.from(context);
            final RegisterImageCodeDialog dialog = new RegisterImageCodeDialog(context, R.style.mystyle);
            ...
            apiServer.imageCode(url).subscribeOn(Schedulers.io())
                    ...
                    .subscribeWith(new BaseObserver<ResponseBody>() {
                        ...
                        public void onError(Throwable e) {
                            super.onError(e);
                            Toast.makeText(context,"网络不太顺畅哦~",Toast.LENGTH_LONG).show();
                            ImageLoad.getImageLoad().LoadImage(context, R.drawable.afresh_image, imageCode);
                        }
                    });
        }
