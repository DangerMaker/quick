...
public class MoneyUtil {
    ...
    public static String moneySub(String valueStr, String minusStr) {
        valueStr = pattern.matcher(valueStr).replaceAll("").trim();
        minusStr = pattern.matcher(minusStr).replaceAll("").trim();
        BigDecimal value = new BigDecimal(valueStr);
    ...
    public static String formatMoney2(String value){
        ...
        String moneyValue = pattern.matcher(value).replaceAll("").trim();

        DecimalFormat df = new DecimalFormat(",###,##0.##");


        return df.format(new BigDecimal(moneyValue));
