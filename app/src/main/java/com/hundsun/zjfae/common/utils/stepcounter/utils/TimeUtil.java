...
public class TimeUtil {
    ...
    public static String getLastDate() {
        String currentDateStr = dateFormat.format(Calendar.getInstance().getTime().getTime() - 86400000L);
        return currentDateStr;
    }
    ...
    public static boolean shutdownBySystemRunningTime(Context mContext) {
...
//            Logger.e(TAG, "上次运行的时间大于当前运行时间判断为重启，只是增加精度，极端情况下连续重启，会判断不出来");
     ...
     * @return
     */
    public static double daysBetween2(String startTime, String endTime) {
        ...
        Double between_days = (time2 - time1) / (1000 * 3600.0);
