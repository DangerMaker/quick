...
public class XNumberKeyboardView extends KeyboardView implements KeyboardView.OnKeyboardActionListener {
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        if (primaryCode == Keyboard.KEYCODE_DELETE) {
            if (mOnKeyboardListener != null){
                ...
                mOnKeyboardListener.onDeleteKeyEvent(mList);
            }
        ...
        // 点击了数字按键
            ...
            if (mOnKeyboardListener != null) {
                if (mList.size() < 6){
                    mList.add(Character.toString(
                            (char) primaryCode));
                    mOnKeyboardListener.onInsertKeyEvent(mList);
                }
                else {
    ...
    public interface IOnKeyboardListener {
         ...
         * @param text 输入的数字
         */
        void onInsertKeyEvent(List<String> list);

        /**
         * 点击了删除按键。
         */
        void onDeleteKeyEvent(List<String> list);
