package com.hundsun.zjfae.common.utils.stepcounter.utils;
...
public class PreferencesHelper {
    ...
    public static final String STEP_TODAY_CURRENT = "step_current_today";
    // 清除步数
    ...
    public static void setStepTodayCurrentTime(Context context, String stepToday) {
        getSharedPreferences(context).edit().putString(STEP_TODAY_CURRENT, stepToday).commit();
    }

    public static String getStepTodayCurrentTime(Context context) {
        return getSharedPreferences(context).getString(STEP_TODAY_CURRENT, "");
    }
