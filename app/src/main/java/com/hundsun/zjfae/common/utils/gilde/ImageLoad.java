...
public class ImageLoad {
     ...
     * @param errorId       图片加载失败占位图
     */
    public void LoadImage(Context context, String url, ImageView imageView, int placeholderId, int errorId) {
    ...
    public void loadImage(Fragment fragment,String url,RequestOptions option,ImageView imageView){
        if (fragment == null) {
            return;
        }
        RequestOptions options = new RequestOptions().skipMemoryCache(true);
