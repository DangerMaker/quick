...
public class UpdateFragment extends BaseDialogFragment implements View.OnClickListener {
    ...
    private static CancelAppUpdate cancelAppUpdateListener;
    ...
    public static void showFragment(FragmentActivity activity, boolean isForceUpdate,
                                    String apkUrl, String apkName, String desc, String updateImage, String updateVersionid, CancelAppUpdate cancelAppUpdate) {
        ...
        bundle.putString("updateImage", updateImage);
        bundle.putString("updateVersionid", updateVersionid);
        cancelAppUpdateListener = cancelAppUpdate;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (arguments != null) {
            ...
            updateImage = arguments.getString("updateImage");
            updateVersionid = arguments.getString("updateVersionid");
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (outState != null) {
            ...
            updateImage = outState.getString("updateImage");
            updateVersionid = outState.getString("updateVersionid");
        }
    }
    ...
    private void initView(View view) {
        ...
        Glide.with(mActivity).load(updateImage).into(mIvTop);
        title.setText("发现新版本" + updateVersionid);
    }
    ...
    private void createFilePath() {
        //获取下载保存path
        saveApkPath = UpdateUtils.apkPath(updateVersionid, mActivity).getPath();
        Log.e("saveApkPath", saveApkPath);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.tv_ok) {
            ...
            switch (downloadStatus) {
                ...
                case UpdateUtils.DownloadStatus.FINISH:
                    ...
                    if (file.exists()) {
                        ...
                        UpdateUtils.installNormal(mActivity, saveApkPath, mActivity.getApplication().getPackageName());
                        //dismissDialog();
                    } else {
                        checkPermissionAndDownApk();
                    }
            ...
            dismissDialog();
            if (cancelAppUpdateListener != null) {

                cancelAppUpdateListener.onCancelAppUpdate();
            }
        }
    }
...
//        }
    ...
    protected void setNotification(int progress) {
        ...
        Notification notification = notificationUtils.setContentIntent(pendingIntent)
                ...
                .getNotification("来了一条消息", "下载apk", R.drawable.logo);
        //下载成功或者失败
    ...
    public interface CancelAppUpdate {


        void onCancelAppUpdate();
